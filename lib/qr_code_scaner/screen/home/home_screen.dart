...
import 'package:meal_mate/qr_code_scaner/screen/scaneer/qr_scranner_screen.dart';
import 'package:meal_mate/utils/style/app_text_style.dart';
import 'package:qr_flutter/qr_flutter.dart';

import '../../service/widget_saver_service.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      productModel.name,
                      style: AppTextStyle.recolateMedium.copyWith(fontSize: 32),
                    ),
                    Row(
                    ...
                    Text(
                      ...
                      style: AppTextStyle.recolateBold.copyWith(fontSize: 16),
                    ),
                    Row(
                      children: [
                        TextButton(
